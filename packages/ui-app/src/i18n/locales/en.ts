...
export const en: Record<TranslationKey, string> = {
  ...
  'setBuilder.rateLimitWaiting': 'Retrying in {n} sec (attempt {attempt})…',
  'setBuilder.nesting': 'Nesting…',
  ...
  'setBuilder.toast.rateLimitRetry': 'Rate limit hit. Attempt {attempt}: retrying in {n} sec…',
