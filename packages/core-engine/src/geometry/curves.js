 ...
 */
import { lenVec3, DEG2RAD, EPSILON, } from './math.js';
// ─── Дуга (ARC) ────────────────────────────────────────────────────
/**
 ...
 */
export function tessellateArc(center, radius, startAngleDeg, endAngleDeg, segments) {
 ...
 */
export function tessellateCircle(center, radius, segments) {
    const points = [];
 ...
 */
export function tessellateEllipse(center, majorAxis, minorRatio, startAngle, endAngle, segments) {
 ...
 */
export function tessellateSpline(degree, controlPoints, knots, weights, segments) {
 ...
 */
function generateUniformKnots(numControlPoints, degree) {
 ...
 */
export function tessellateBulge(p1, p2, bulge, segments) {
 ...
 */
export function tessellateLWPolyline(vertices, bulges, closed, segments) {
