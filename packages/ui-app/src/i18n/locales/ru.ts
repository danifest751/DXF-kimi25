export const ru = {
  ...
  'setBuilder.rateLimitWaiting': 'Повтор через {n} сек (попытка {attempt})…',
  ...
  'setBuilder.toast.rateLimitRetry': 'Лимит запросов. Попытка {attempt}: повтор через {n} сек…',
  'setBuilder.nesting': 'Раскладка…',
  ...
  'setBuilder.dragModeOn': 'Режим перетаскивания',
  'setBuilder.dragModeOff': 'Перетаскивание выкл',
  'setBuilder.sheetResave': 'Перезаписать хеш',
  'setBuilder.sheetResaved': 'Хеш перезаписан',
  'setBuilder.sheetResaving': 'Сохранение…',
  'setBuilder.autoArrange': 'Авторасстановка',
  'setBuilder.autoArranging': 'Авторасстановка…',
  'setBuilder.autoArrangeDone': 'Расставлено',
