...
// ─── Point2D ────────────────────────────────────────────────────────
export function pt2(x, y) {
    return { x, y };
}
export function addPt2(a, b) {
    return { x: a.x + b.x, y: a.y + b.y };
}
export function subPt2(a, b) {
    return { x: a.x - b.x, y: a.y - b.y };
}
export function scalePt2(p, s) {
    return { x: p.x * s, y: p.y * s };
}
export function distPt2(a, b) {
    const dx = a.x - b.x;
    const dy = a.y - b.y;
    return Math.sqrt(dx * dx + dy * dy);
}
export function lenPt2(p) {
    return Math.sqrt(p.x * p.x + p.y * p.y);
}
// ─── Point3D ────────────────────────────────────────────────────────
export function pt3(x, y, z) {
    return { x, y, z };
}
export function addPt3(a, b) {
    return { x: a.x + b.x, y: a.y + b.y, z: a.z + b.z };
}
export function subPt3(a, b) {
    return { x: a.x - b.x, y: a.y - b.y, z: a.z - b.z };
}
export function scalePt3(p, s) {
    return { x: p.x * s, y: p.y * s, z: p.z * s };
}
export function distPt3(a, b) {
    const dx = a.x - b.x;
    const dy = a.y - b.y;
    const dz = a.z - b.z;
    return Math.sqrt(dx * dx + dy * dy + dz * dz);
}
export function lenPt3(p) {
    return Math.sqrt(p.x * p.x + p.y * p.y + p.z * p.z);
}
export function normalizePt3(p) {
    const l = lenPt3(p);
    if (l < EPSILON)
        return { x: 0, y: 0, z: 0 };
    return { x: p.x / l, y: p.y / l, z: p.z / l };
}
export function dotPt3(a, b) {
    return a.x * b.x + a.y * b.y + a.z * b.z;
}
export function crossPt3(a, b) {
    return {
        x: a.y * b.z - a.z * b.y,
        y: a.z * b.x - a.x * b.z,
        z: a.x * b.y - a.y * b.x,
...
export function vec3ToPoint(v) {
    return { x: v.dx, y: v.dy, z: v.dz };
}
export function pointToVec3(p) {
...
export function mat4RotationZ(radians) {
 ...
 */
export function buildInsertMatrix(position, rotation, scaleX, scaleY, scaleZ, basePoint) {
 ...
 */
export function ocsToWcsMatrix(normal) {
