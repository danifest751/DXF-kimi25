 ...
 */
/** Формат DXF файла */
export declare enum DXFFormat {
    ASCII = "ASCII",
    BINARY = "BINARY"
}
/** Версия DXF */
export declare enum DXFVersion {
    R12 = "R12",
    R2000 = "2000",
    R2004 = "2004",
    R2007 = "2007",
...
export declare enum DXFEntityType {
    LINE = "LINE",
    XLINE = "XLINE",
    RAY = "RAY",
    CIRCLE = "CIRCLE",
...
export type DXFEntity = DXFLineEntity | DXFXLineEntity | DXFRayEntity | DXFCircleEntity | DXFArcEntity | DXFEllipseEntity | DXFSplineEntity | DXFPolylineEntity | DXFLWPolylineEntity | DXFPointEntity | DXFSolidEntity | DXFTraceEntity | DXFTextEntity | DXFMTextEntity | DXFHatchEntity | DXFDimensionEntity | DXFLeaderEntity | DXFMLeaderEntity | DXFInsertEntity | DXFAttdefEntity | DXFAttribEntity | DXF3DFaceEntity | DXFImageEntity | DXFUnderlayEntity | DXFViewportEntity;
...
export declare class DXFError extends Error {
